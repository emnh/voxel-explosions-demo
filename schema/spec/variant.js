...
}catch (e8159){if((e8159 instanceof Object)){
var e_SHARP_ = e8159;
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__6834__auto__,k8161,else__6835__auto__){
var self__ = this;
var this__6834__auto____$1 = this;
var G__8163 = (((k8161 instanceof cljs.core.Keyword))?k8161.fqn:null);
switch (G__8163) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k8161,else__6835__auto__);
...
var or__6210__auto____$1 = self__.post.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x));
...
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__6842__auto__)),null));
}
});

schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__6839__auto__,k__6840__auto__,G__8160){
var self__ = this;
var this__6839__auto____$1 = this;
var pred__8164 = cljs.core.keyword_identical_QMARK_;
var expr__8165 = k__6840__auto__;
if(cljs.core.truth_(pred__8164.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__8165))){
return (new schema.spec.variant.VariantSpec(G__8160,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__8164.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__8165))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__8160,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__8164.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__8165))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__8160,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__8164.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__8165))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__8160,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__6840__auto__,G__8160),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__6831__auto__,G__8160){
var self__ = this;
var this__6831__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__8160,self__.__extmap,self__.__hash));
});
...
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__8162){
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__8162),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__8162),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__8162),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__8162),null,cljs.core.dissoc.call(null,G__8162,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)),null));
});
...
var args8168 = [];
var len__7279__auto___8171 = arguments.length;
var i__7280__auto___8172 = (0);
while(true){
if((i__7280__auto___8172 < len__7279__auto___8171)){
args8168.push((arguments[i__7280__auto___8172]));

var G__8173 = (i__7280__auto___8172 + (1));
i__7280__auto___8172 = G__8173;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__6210__auto__ = err_f;
if(cljs.core.truth_(or__6210__auto__)){
return or__6210__auto__;
} else {
