...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__13783_SHARP_){
return ((p1__13783_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__13783_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__13785,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__13785;
}
});
...
var len__7279__auto___13788 = arguments.length;
var i__7280__auto___13789 = (0);
while(true){
if((i__7280__auto___13789 < len__7279__auto___13788)){
args__7286__auto__.push((arguments[i__7280__auto___13789]));

var G__13790 = (i__7280__auto___13789 + (1));
i__7280__auto___13789 = G__13790;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__7287__auto__);
});
...
var G__13787 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__13787,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__13787;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq13786){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13786));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__13794,(0),null);
var names = cljs.core.nth.call(null,vec__13794,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__13794,tag_name,names){
return (function (p1__13791_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__13791_SHARP_));
});})(matches,vec__13794,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__13794,tag_name,names){
return (function (p1__13792_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__13792_SHARP_));
});})(matches,vec__13794,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__13795){
var vec__13798 = p__13795;
var tag = cljs.core.nth.call(null,vec__13798,(0),null);
var content = cljs.core.nthnext.call(null,vec__13798,(1));
...
var vec__13799 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__13799,(0),null);
var id = cljs.core.nth.call(null,vec__13799,(1),null);
var class$ = cljs.core.nth.call(null,vec__13799,(2),null);
